...
<body>
	<div class="container">
		<div id="header">
			<div class="logo">
				<a href="<?php echo IUrl::creatUrl("/system/default");?>"><img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/logo.gif";?>" width="303" height="60" /></a>
			</div>
			<div id="menu">
				<ul name="menu">
				</ul>
		...
		<div id="admin_right">
			<script type="text/javascript" charset="UTF-8" src="/jihuasuan/runtime/_systemjs/editor/kindeditor-min.js"></script><script type="text/javascript" charset="UTF-8" src="/jihuasuan/runtime/_systemjs/editor/lang/zh_CN.js"></script><script type="text/javascript">window.KindEditor.options.uploadJson = "/jihuasuan/pic/upload_json";window.KindEditor.options.fileManagerJson = "/jihuasuan/pic/file_manager_json";</script>
<script type="text/javascript" charset="UTF-8" src="/jihuasuan/runtime/_systemjs/artTemplate/artTemplate.js"></script><script type="text/javascript" charset="UTF-8" src="/jihuasuan/runtime/_systemjs/artTemplate/artTemplate-plugin.js"></script>
<div class="headbar">
					...
					<td>
						...
						<table class='border_table' id='guide_box'>
							...
							<tr class='td_c'>
								...
								<td><input type='text' name='guide_link[]' class='middle' value='<%=link%>' pattern='required' alt='请填写URL，如：http://www.jihuasuan.cn' /></td>
								<td>
		...
		<form action="<?php echo IUrl::creatUrl("/system/save_conf/form_index/sms_conf");?>"  method="post" enctype='multipart/form-data' name='sms_conf'>
			...
			<table class="form_table">
				...
				<tr>
					<th></th>
					<td>
						<button type='submit' class="submit" ><span>保存短信设置</span></button>
					</td>
				</tr>
			</table>
		</form>
