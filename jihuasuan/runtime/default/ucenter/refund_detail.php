...
<div class="main f_r" style='width:765px;'>
	...
	<div class="box m_10">
		<table class="border_table dark_gray" width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td><b>涉及订单：</b><?php echo isset($info['order_no'])?$info['order_no']:"";?></td>
				<td><?php if($info['pay_status']==0){?><span class="orange bold">正在处理中</span><?php }elseif($info['pay_status']==1){?><span class="red bold">退款失败</span><?php }elseif($info['pay_status']==2){?><span class="green bold sel">退款成功</span><?php }?></td>
			</tr>
			<tr>
				<td><b>申请时间：</b><?php echo isset($info['time'])?$info['time']:"";?></td>
				<td><b>退款金额：</b><span class="red2 bold"><?php echo isset($info['amount'])?$info['amount']:"";?></span></td>
			</tr>
			<tr><td colspan="2"><b>退款原因：</b><?php echo isset($info['content'])?$info['content']:"";?></td></tr>
			<tr><td colspan="2"><b>处理时间：</b><?php echo $info['dispose_time']?$info['dispose_time']:'未处理';?></td></tr>
			<tr><td colspan="2"><b>处理建议：</b><?php echo $info['dispose_idea']?$info['dispose_idea']:'未回复';?></td></tr>
			<tr>
