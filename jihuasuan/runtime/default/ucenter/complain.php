...
<div class="ucenter container">
    ...
    <table class="list_table m_10" width="100%" cellpadding="0" cellspacing="0">
        ...
        <?php $complain = new IQuery("suggestion");$complain->where = "user_id = $user_id";$complain->page = "$page";$items = $complain->find(); foreach($items as $key => $item){?>
            <tr>
        ...
        <tfoot><tr><td colspan="3" class="t_l"><?php echo $complain->getPageBar();?></td></tr></tfoot>
    </table>
