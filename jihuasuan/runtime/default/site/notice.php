	...
	<div class="box m_10">
		...
		<div class="cont">
			...
			<ul class="newslist">
				...
				<?php $announcement = new IQuery("announcement");$announcement->order = "id desc";$announcement->page = "$page";$items = $announcement->find(); foreach($items as $key => $item){?>
			...
			<?php echo $announcement->getPageBar();?>
		</div>
	</div>
</div>
</div>
