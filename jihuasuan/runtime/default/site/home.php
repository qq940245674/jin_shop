...
<div class="wrapper clearfix container_2">
		...
		<div class="box m_10" style='width:987px;margin-top:5px;'>
			...
			<div class="content">
				<div class="c_box">
					...
					<p> 淘宝店铺：<a href="<?php echo isset($sellerRow['home_url'])?$sellerRow['home_url']:"";?>" target="_blank" class="orange">点击进入</a></p>
	...
	<div class="main f_l" style='width:1000px;'>
		...
		<br>
		<?php $goodsObj = search_goods::find(' go.seller_id = '.$seller_id);$resultData = $goodsObj->find();?>
		<?php if($resultData){?>
