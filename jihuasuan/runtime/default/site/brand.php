...
<div class="wrapper clearfix container_2">
	...
	<div class="main f_r">
		...
		<?php if(isset($name) && $name != ''){?>
			<div class="title"><?php echo isset($name)?$name:"";?></div>
			<div class="cont">
				<ul class="piclist_2">
					<?php $query = new IQuery("brand");$query->order = "sort asc";$query->where = "CONCAT(',',category_ids,',') like('%,$id,%')";$items = $query->find(); foreach($items as $key => $item){?>
					<li>
					<a class="pic" href="<?php echo IUrl::creatUrl("/site/brand_zone/id/$item[id]");?>"><img src="<?php echo IUrl::creatUrl("")."$item[logo]";?>" width="154" height="109" /></a>
					<a href="<?php echo isset($item['url'])?$item['url']:"";?>"><h3><?php echo isset($item['name'])?$item['name']:"";?></h3></a>
					</li>
					<?php }?>
				</ul>
			</div>
		<?php }else{?>
			...
			<div class="cont">
				<ul class="piclist_2">
					...
					<li>
					<a class="pic" href="<?php echo IUrl::creatUrl("/site/brand_zone/id/$item[id]");?>"><img src="<?php echo IUrl::creatUrl("")."$item[logo]";?>" width="154px" height="109px" /></a>
					<a href="<?php echo isset($item['url'])?$item['url']:"";?>"><h3><?php echo isset($item['name'])?$item['name']:"";?></h3></a>
					</li>
					<?php }?>
				</ul>
