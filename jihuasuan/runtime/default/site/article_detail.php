		...
		<div class="box m_10">
			...
			<div class="parts clearfix">
				<ul class="prolist">
					...
					<li>
						<a href="<?php echo IUrl::creatUrl("/site/products/id/$item[id]");?>"><img width="98" height="106" src="<?php echo IUrl::creatUrl("")."";?><?php echo Thumb::get($item['img'],98,106);?>" alt="<?php echo isset($item['name'])?$item['name']:"";?>"></a>
