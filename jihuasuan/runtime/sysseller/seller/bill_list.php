...
<h4 class="alert_info"><?php echo $siteConfig->name;?>给您的商品货款结算账单展示</h4>
...
<article class="module width_full">
	...
	<table class="tablesorter" cellspacing="0">
		...
		<tbody>
			...
			<?php $query = new IQuery("bill");$query->where = "seller_id = $seller_id";$query->page = "$page";$items = $query->find(); foreach($items as $key => $item){?>
			<tr>
				...
				<td><?php echo isset($item['pay_content'])?$item['pay_content']:"";?></td>
				<td>
					<a href="<?php echo IUrl::creatUrl("/seller/bill_edit/id/$item[id]");?>">
						<img title="修改" alt="修改" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/main/icn_edit.png";?>" />
					</a>

					<?php if($item['is_pay'] == 0){?>
					<a href="javascript:delModel({link:'<?php echo IUrl::creatUrl("/seller/bill_del/id/$item[id]");?>'})">
						<img src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/main/icn_del.png";?>" title="删除" />
					</a>
					<?php }?>
				</td>
			</tr>
